...
inline std::string to_yaml(const UdpSend_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const udp_msgs::srv::UdpSend_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const udp_msgs::srv::UdpSend_Request & msg)
{
...
inline std::string to_yaml(const UdpSend_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use udp_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const udp_msgs::srv::UdpSend_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  udp_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use udp_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const udp_msgs::srv::UdpSend_Response & msg)
{
  return udp_msgs::srv::to_yaml(msg);
}
